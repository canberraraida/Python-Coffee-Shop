...
print("Welcome to the Python Coffee Shop!")   
custome_name = input("What is your name? ")
print("Hello, " + cutsomer_name + "! Let's order some coffee.")
price_coffee = 3.50
price_latte = 4.00
print("Coffee: $" + str(price_coffee))
print("Latte: $" + str(price_latte))
...
if choice == "coffee":
    ...
    cost = 0
quantity = int(input("How many cups you would you like? "))
total_cost = cost * quantity

if quantity > 1:
          print("You get a discount of $1.00!")
          total_cost -= 1.00
print("You total is: $" + str(total_cost))
